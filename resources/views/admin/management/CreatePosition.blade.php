    ...
    <div class="py-12">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="dashboard-card overflow-hidden">
                ...
                <form action="{{ route('admin.add.position.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="p-6 md:p-8">
                        ...
                        <div class="mb-6">
                            ...
                            <select name="availability" class="w-full bg-white/10 border border-white/20 rounded-lg px-4 py-2 text-white focus:ring-2 focus:ring-red-500 focus:border-transparent">
                                <option value="available" {{ old('availability') == 'available' ? 'selected' : '' }} class="bg-gray-800">Available</option>
                                <option value="full" {{ old('availability') == 'full' ? 'selected' : '' }} class="bg-gray-800">Full / No Slots</option>
                            </select>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="about_position" rows="6"
                                      class="w-full bg-white/10 border border-white/20 rounded-lg px-4 py-2 text-white focus:ring-2 focus:ring-red-500 focus:border-transparent">{{ old('about_position') }}</textarea>
                        </div>
