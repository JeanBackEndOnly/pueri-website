            ...
            <div class="dashboard-card overflow-hidden">
                ...
                <div class="p-4 border-b border-white/10">
                    <a href="{{ route('admin.unit') }}" class="inline-flex items-center text-white/70 hover:text-white transition">
                        ...
                        Back to Our section unit
                    </a>
                </div>
                
                <form action="{{ route('admin.add.unit.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="p-6 md:p-8">
                        ...
                        <div class="flex flex-col md:flex-row items-center md:items-start gap-6 mb-8">
                            ...
                            <div class="flex-1 space-y-4">
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-white/80 mb-1">About Section/Unit</label>
                                    <textarea name="unit_description" rows="5"
                                        class="w-full bg-white/10 border border-white/20 rounded-lg px-4 py-2 text-white focus:ring-2 focus:ring-red-500 focus:border-transparent">{{ old('unit_description') }}</textarea>
                                </div>
                            </div>
                        </div>
