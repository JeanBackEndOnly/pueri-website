        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-12 md:py-16 lg:py-20">
            ...
            <div class="relative min-h-screen flex items-center justify-center -mt-20">
                <div class="relative z-10 text-center px-4 pt-12 sm:pt-0 lg:pt-0 md:pt-0 sm:px-6 lg:px-8 max-w-7xl mx-auto">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center mb-16">
                        ...
                        <a href="#services" class="group smooth-link inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm hover:bg-white/20 text-white px-8 py-4 rounded-xl font-semibold transition-all duration-300 border border-white/20">
           ...
           @if(isset($offers) && $offers->count())
            ...
            @if ($information->isNotEmpty())
                ...
                <!-- Team Members -->
                <div>
                    <h2 class="text-2xl md:text-3xl font-bold text-center text-white mb-8" id="teamTitle">
                        Team Members
                    </h2>
                    <div id="membersContainer" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 lg:gap-8">
            ...
            @else
                <div class="text-center py-20 bg-white/5 backdrop-blur-sm rounded-3xl">
                    ...
                    <p class="text-white/50 text-sm mt-2">Start by adding section/unit details.</p>
                </div>
            @endif
            ...
            @if(isset($jobs) && $jobs->count())
                <div class="mt-20" id="positions">
                    ...
                    <div class="jobs-slider-container relative">
                        <div class="jobs-slider-track" id="jobsSliderTrack">
                            @foreach ($jobs as $job)
                                <div class="jobs-slider-slide">
                                    <div class="bg-white/5 backdrop-blur-sm rounded-2xl shadow-xl overflow-hidden mx-4 border border-white/10">
                                        <div class="p-8 lg:p-10">
                                            <div class="flex flex-col items-center text-center">
                                                ...
                                                <div class="flex flex-wrap justify-center gap-3 mb-5">
                                                    <span class="px-4 py-1.5 bg-blue-500/20 text-blue-300 rounded-full text-sm font-semibold">
                                                        📍 {{ $job->available_quantity }} slot(s) available
                                                    </span>
                                                    <span class="px-4 py-1.5 rounded-full text-sm font-semibold
                                                        @if($job->availability == 'available') bg-green-500/20 text-green-300
                                                        @else bg-red-500/20 text-red-300
                                                        @endif">
                                                        {{ ucfirst($job->availability) }}
                                                    </span>
                                                </div>
                                                <p class="text-white/70 leading-relaxed max-w-2xl">{{ $job->about_position }}</p>
                                                @if($job->availability == 'available')
                                                    <div class="mt-7">
                                                        <a href="{{ route('apply.job', $job->id) }}" class="inline-flex items-center gap-2 bg-red-500 hover:bg-red-600 text-white px-8 py-3 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 shadow-md">
                                                            Apply Now
                                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                ...
                                                @else
                                                    <div class="mt-7">
                                                        <span class="inline-flex items-center gap-2 bg-white/10 text-white/50 px-8 py-3 rounded-xl font-semibold cursor-not-allowed">
                                                            No Slots Available
                                                        </span>
                                                    </div>
                                                @endif
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="text-center">
                <p class="text-white/50 text-sm">
                    © {{ date('Y') }} Puericulture Center. All rights reserved.
                </p>
            </div>
        </div>
    </footer>
    ...
    <script>
        ...
        if (offersData.length > 0) {
            ...
            function offersUpdateSlider() {
                if (offersTrack) {
                    offersTrack.style.transform = `translateX(-${offersCurrentIndex * 100}%)`;
                }
                if (offersDotsContainer) {
            ...
            function offersGoToSlide(index) {
                offersCurrentIndex = index;
                offersUpdateSlider();
            }
            
            function offersNextSlide() {
                offersCurrentIndex = (offersCurrentIndex + 1) % offersTotalSlides;
                offersUpdateSlider();
            }
            
            function offersPrevSlide() {
                offersCurrentIndex = (offersCurrentIndex - 1 + offersTotalSlides) % offersTotalSlides;
                offersUpdateSlider();
            }
            ...
            let offersAutoSlide = setInterval(offersNextSlide, 5000);
        ...
        if (jobsData.length > 0) {
            ...
            function jobsUpdateSlider() {
                if (jobsTrack) {
                    jobsTrack.style.transform = `translateX(-${jobsCurrentIndex * 100}%)`;
                }
                if (jobsDotsContainer) {
            ...
            function jobsGoToSlide(index) {
                jobsCurrentIndex = index;
                jobsUpdateSlider();
            }
            
            function jobsNextSlide() {
                jobsCurrentIndex = (jobsCurrentIndex + 1) % jobsTotalSlides;
                jobsUpdateSlider();
            }
            
            function jobsPrevSlide() {
                jobsCurrentIndex = (jobsCurrentIndex - 1 + jobsTotalSlides) % jobsTotalSlides;
                jobsUpdateSlider();
            }
            ...
            let jobsAutoSlide = setInterval(jobsNextSlide, 5000);
            ...
            if (jobsContainer) {
                ...
                jobsContainer.addEventListener('mouseleave', () => {
